  ...
  [
    {
      ...
      photos_images: [File.open('./app/assets/images/product/pressure/71Q8R5woLDL._AC_SL1000_.jpg'),File.open('./app/assets/images/product/pressure/61FXZNyA8zL._AC_SL1000_.jpg')],
    ...
    },
    {
      ...
      cost: '655',
      period_of_use: '1年1ヶ月',
      photos_images: [File.open('./app/assets/images/product/egg/719ie8NXEqL._AC_SL1500_.jpg'),File.open('./app/assets/images/product/egg/51oPdyLPl+L._AC_SL1446_.jpg'), File.open('./app/assets/images/product/egg/81h7QpFcbBL._AC_SL1500_.jpg')],
      merits_attributes: [{advantage: "コンロを使わず、電子レンジでできるためキッチンから離れることができる"}, {advantage: "慣れてくると電子レンジでも好みの黄身の固さに調整できる"}],
...
現在の室温と湿度が見やすく表示され、同時に過去最高最低の温湿度値も表示される。\n 最高と最低のデータは24時間で自動リセットするか、リセットするまでの全ての期間での最高最低を表示するのかをボタンひとつで切り替えられる。",
    ...
    },
    {
      ...
      cost: '2791',
      period_of_use: '1年3ヶ月',
      photos_images: [File.open('./app/assets/images/product/laundry/61dy+AxlF0L._AC_SL1000_.jpg'),File.open('./app/assets/images/product/laundry/61p96f4ioML._AC_SL1000_.jpg'),File.open('./app/assets/images/product/laundry/613ik+fij3L._AC_SL1000_.jpg'), File.open('./app/assets/images/product/laundry/61BAqbWbA1L._AC_SL1000_.jpg')],
    ...
    },
    {
      ...
      cost: '2272',
      period_of_use: '1年1ヶ月',
      photos_images: [File.open('./app/assets/images/product/mill/71BUc8ZMZHL._AC_SL1500_.jpg'),File.open('./app/assets/images/product/mill/61t1zmQoBlL._AC_SL1000_.jpg'),File.open('./app/assets/images/product/mill/61NRF9d5E3L._AC_SL1000_.jpg')],
      merits_attributes: [{advantage: "水洗いができる"}, {advantage: "ワンタッチで操作が楽"}, {advantage: "意外と音が静か"}, {advantage: "スタイリッシュ"}],
    ...
    },
    {
      ...
      cost: '1070',
      period_of_use: '2年2ヶ月',
      photos_images: [File.open('./app/assets/images/product/meter/3.jpg'),File.open('./app/assets/images/product/meter/4.jpg')],
    ...
    },
    {
      ...
      demerits_attributes: [{disadvantage: "スピーカーとBluetooth接続する時、接続が遅いときがある"}, {disadvantage: "時々接続が悪くなり、音声が途切れたりする"}],
